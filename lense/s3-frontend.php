...
<style>
    ...
    <main>  <div class = "h-100 center-me">
        <div class =" my-auto">
    <form action = "includes/s3-upload-helper.php" method="POST" enctype="multipart/form-data">
        <div class="form-group">
                <img src="<?php echo $photo ;?>" onclick="triggered();"id="s3-display">
                <label for="s3-image" id="Uname-style">S3 upload</label>
                <input type="file" name ="s3-image" id="s3-image" onchange="preview(this)" class="form-control" style="display: non;">
